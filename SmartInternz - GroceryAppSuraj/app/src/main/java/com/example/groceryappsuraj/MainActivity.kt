package com.example.groceryappsuraj
...
class MainActivity : AppCompatActivity(), GroceryRVAdapter.GroceryItemClickInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        groceryViewModal = ViewModelProvider(this, factory).get(GroceryViewModel::class.java)
    ...
    fun openDialog() {
        ...
        dialog.setContentView(R.layout.grocery_add_dialogue)
